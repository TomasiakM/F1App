...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231204160850_Add driver & team statistics models")]
    partial class Adddriverteamstatisticsmodels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Aggregates.DriverStatistics.DriverStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DriverStatistics", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Aggregates.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Aggregates.TeamStatistics.TeamStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Aggregates.UserDriverRatings.UserDriverRating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserDriverRatings", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Aggregates.DriverStatistics.DriverStatistic", b =>
                {
                    b.HasOne("Domain.Aggregates.Drivers.Driver", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Aggregates.Ratings.Rating", b =>
                {
                    b.HasOne("Domain.Aggregates.RaceWeeks.RaceWeek", null)
                        .WithOne()
                        .HasForeignKey("Domain.Aggregates.Ratings.Rating", "RaceWeekId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("Domain.Aggregates.Drivers.ValueObjects.DriverId", "DriverIds", b1 =>
                        {
                            ...
                            b1.HasKey("RatingId", "Id");

                            b1.ToTable("RatingDrivers", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("RatingId");
                        });

                    b.OwnsMany("Domain.Aggregates.Ratings.Entities.DriverRating", "DriverRatings", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("RatingId");

                            b1.ToTable("DriverRatings", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("RatingId");
                        });

                    b.Navigation("DriverIds");
            ...
            modelBuilder.Entity("Domain.Aggregates.TeamStatistics.TeamStatistic", b =>
                {
                    b.HasOne("Domain.Aggregates.Teams.Team", null)
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Aggregates.UserDriverRatings.UserDriverRating", b =>
                {
                    b.HasOne("Domain.Aggregates.Ratings.Rating", null)
                        .WithMany()
                        .HasForeignKey("RatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
