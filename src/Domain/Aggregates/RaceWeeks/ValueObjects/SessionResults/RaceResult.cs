...
public sealed class RaceResult : SessionResult
{
    ...
    private RaceResult(int place, int laps, TimeSpan fastestLap, FinishType finishType, int startPosition, TimeSpan finishTime, float points, DriverId driverId)
    ...
    public static RaceResult Create(int place, int laps, TimeSpan fastestLap, FinishType finishType, int startPosition, TimeSpan finishTime, float points, DriverId driverId)
