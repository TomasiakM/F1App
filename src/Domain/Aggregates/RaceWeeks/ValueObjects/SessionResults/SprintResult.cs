...
public sealed class SprintResult : SessionResult
{
    ...
    private SprintResult(int place, int laps, TimeSpan? fastestLap, FinishType finishType, int startPosition, TimeSpan? finishTime, float points, DriverId driverId, TeamId teamId)
    ...
    public static SprintResult Create(int place, int laps, TimeSpan? fastestLap, FinishType finishType, int startPosition, TimeSpan? finishTime, float points, DriverId driverId, TeamId teamId)
    ...
    private SprintResult() : base(0, 0, TimeSpan.Zero, DriverId.Create(), TeamId.Create()) { }
}
